        ...
        <div className='object-cover flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl'>
          ...
          <div className="w-full p-4 lg:w-1/2">
            ...
            <Form layout='vertical' onFinish={onFinish} className='flex flex-col gap-0.5'>
              ...
              <Form.Item name='email' className='border p-1 rounded-lg focus:outline-none focus:border-blue-500' rules={[{ required: true, message: 'Please enter your email' }, { type: 'email', message: 'Invalid email address' }]}>
                <input
                  type='email'
              ...
              <Form.Item name='password' className='border p-1 rounded-lg focus:outline-none focus:border-blue-500' rules={[{ required: true, message: 'Please enter your password' }, { min: 6, message: 'Password must be at least 6 characters' }]}>
                <input
                  type='password'
              ...
              <Form.Item name='password_confirmation' className='border p-1 rounded-lg focus:outline-none focus:border-blue-500' rules={[{ required: true, message: 'Please confirm your password' }, { min: 6, message: 'Password must be at least 6 characters' }]}>
                <input
                  type='password'
                  className='border-none p-1 rounded-lg focus:outline-none focus:border-blue-500 w-full'
