    ...
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 mb-12">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-6">
            by register your property in this form and add a neccesary information free to rent or sell your home. this is a digital Ethiopia platform that helps you to sell or rent your home.
          </p>
      ...
      <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start gap-6 mb-12">
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-6">
            We can shoot your property with professional materials, drones, and photography. Please click the link below and register your property.
          </p>
          <Link to="/explore" className="bg-slate-800 text-white py-2 px-1 rounded-lg hover:bg-green-700 text-center">
            Register Your Property
          </Link>
